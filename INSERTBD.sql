...
VALUES('1', 'Рамок нет', 290, 1),
	  ('2', 'Жить как я живу', 217, 1),
	  ('3', 'Компас', 183, 2),
	  ('4', 'Серпантин', 186, 2),
	  ('5', 'Space Diver', 397, 3),
	  ('6', 'Space Diver2', 612, 3),
	  ('7', 'Лавэ', 150, 4),
	  ('8', 'ХХХ', 117, 4),
	  ('9', 'Дыхание', 219, 5),
	  ('10', 'Русский рок', 264, 5),
	  ('11', 'Проблемы', 130, 6),
	  ('12', 'Не нравится', 142, 6),
	  ('13', 'Одуванчик', 183, 7),
	  ('14', 'Повторим', 156, 7),
	  ('15', 'Gimme The Loot', 129, 8),
	  ('16', '98 Flow', 133, 8),
	  ('17', '99 Problems', 160, 9),
	  ('18', 'Mama Makusa', 114, 9),
	  ('19', 'Mynor', 175, 10),
	  ('20', 'Там ревели горы', 176, 10);
